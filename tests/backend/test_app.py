...
def test_get_activities_returns_activity_catalog(client):
    ...
    assert payload[expected_activity_name]["schedule"] == "Fridays, 3:30 PM - 5:00 PM"
...
def test_signup_for_activity_returns_400_when_student_is_already_signed_up(client):
    # Arrange
...
def test_unregister_participant_returns_success_message(client):
    # Arrange
    activity_name = "Chess Club"
    email = "michael@mergington.edu"
...
def test_unregister_participant_returns_404_when_student_is_not_found(client):
    # Arrange
    activity_name = "Chess Club"
